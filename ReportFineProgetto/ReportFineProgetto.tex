...
\chapter{Architettura}
	\section{In generale}
		Per descrivere l'architettura da noi ideata riteniamo importante descrivere il \emph{provider} al quale abbiamo
		deciso di appoggiarci. La scelta e' ricaduta sullo strumento "\emph{Microsoft Azure}", si tratta di un servizio
		di \emph{Cloud Computing} offerto da \emph{Microsoft}, in particolare esso offre servizi di \emph{Platform as a
		Service}, \emph{Software as a Service} e \emph{Infrastructure as a Service}. In particolare e' stato scelto in
		quanto aderente alle nostre necessita' di gestione di macchine remote da parte di un gruppo organizzato, inoltre
		, \emph{Microsoft} offre un bonus gratuito di credito da spendere sulla piattaforma per ogni persona che vi si
		registri come studente. Cio' in concomitanza con i prezzi in linea con il mercato, ci ha permesso di
		sperimentare senza rischiare di dilapidare denaro.
	\section{Arcitettura di rete}
