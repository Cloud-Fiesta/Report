...
\chapter{Processo di implementazione}\label{processo_di_implementazione}
	...
	fasi, esse ci hanno permesso di poter controllare lo stato di avanzamento dei lavori e modificare i programmi e il
	carico di lavoro in maniera coerente. In particolare possiamo individuare cinque principali fasi, elencate di
	seguito;
	\begin{enumerate}
	...
	\section{Brainstorming e ricerca}\label{brainstorming_e_ricerca}
		...
		componenti di \emph{ICT Security Specialist} si sono occupati di definire acluni strumenti atti alla
		gestione della rete.
