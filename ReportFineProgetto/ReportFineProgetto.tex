		...
		\section{Guesswork e ricerca vulnerabilita'}\label{guesswork_e_ricerca_vulnerabilita}
			...
			\subsection{Guesswork}\label{guesswork}
				...
				\begin{itemize}
					...
					\item L'organizzazione e' chiamata \emph{Cloud Fiesta}, \href{https://github.com/Cloud-Fiesta}{github}
				\end{itemize}
				Tramite queste due informazioni e' possibile tentare di forgiare alcuni \emph{login} che potrebbero
				risultare presenti, riassunti nella seguente tabella:
				\begin{center}
					\begin{tabular}{c c}
					\end{tabular}
				\end{center}
