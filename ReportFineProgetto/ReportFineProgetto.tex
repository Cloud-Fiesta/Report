...
\chapter{Introduzione}\label{introduzione}
	\section{Il Progetto}\label{il_progetto}
		Il qui presente report ha lo scopo di illustrare lo svolgimento del progetto a opera del gruppo "Cloud Fiesta",
		il progetto e' stato commissionato dai docenti Blanchietti Andrea e Zimuel
		Enrico nell'ambito del corso \textit{\quotes{Laboratorio Integrato}}.
